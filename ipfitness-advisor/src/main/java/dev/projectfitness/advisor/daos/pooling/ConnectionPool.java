package dev.projectfitness.advisor.daos.pooling;

import java.sql.*;
import java.util.*;

import dev.projectfitness.advisor.util.Constants.DataSourceProperties;
...
public class ConnectionPool {
	...
	private ConnectionPool() {
		...
		ResourceBundle bundle = PropertyResourceBundle
				.getBundle("dev.projectfitness.advisor.daos.pooling.connectionPool");
